...
SAFE_EXEC_BINARIES = {"php", "npm", "composer", "ffmpeg"}
SAFE_ARTISAN_COMMANDS = {
    "about", "config:show", "env", "list", "route:list", "test",
    "optimize:clear", "config:clear", "cache:clear", "route:clear",
    "view:clear", "filament:assets",
}
...
def project_clone(req: ProjectRequest) -> dict[str, Any]:
    ...
    # Remaining module content unchanged from the existing branch version.
